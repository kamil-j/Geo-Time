...
describe('Service Tests', () => {
    ...
    describe('SchedulingTimeFrame Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(SchedulingTimeFrameService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/scheduling-time-frames';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return SchedulingTimeFrame', () => {
