...
public class DepartmentResourceIntTest {
    ...
    public void setup() {
        ...
        final DepartmentResource departmentResource = new DepartmentResource(departmentService, departmentMapper);
    ...
    public void createDepartment() throws Exception {
        ...
        restDepartmentMockMvc.perform(post("/api/departments")
            ...
            .content(TestUtil.convertObjectToJsonBytes(departmentMapper.toDto(department))))
        ...
        assertThat(testDepartment.isFunctional()).isEqualTo(DEFAULT_FUNCTIONAL);
    }
    ...
    public void getAllDepartments() throws Exception {
        ...
        restDepartmentMockMvc.perform(get("/api/departments?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].functional").value(hasItem(DEFAULT_FUNCTIONAL)));
    }
    ...
    public void getDepartment() throws Exception {
        ...
        restDepartmentMockMvc.perform(get("/api/departments/{id}", department.getId()))
            ...
            .andExpect(jsonPath("$.functional").value(DEFAULT_FUNCTIONAL));
    }
    ...
    public void updateDepartment() throws Exception {
        ...
        restDepartmentMockMvc.perform(put("/api/departments")
            .contentType(TestUtil.APPLICATION_JSON_UTF8)
            .content(TestUtil.convertObjectToJsonBytes(departmentMapper.toDto(updatedDepartment))))
            .andExpect(status().isOk());
        ...
        assertThat(testDepartment.isFunctional()).isEqualTo(UPDATED_FUNCTIONAL);
    }
