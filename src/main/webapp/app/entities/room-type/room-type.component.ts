...
import { ITEMS_PER_PAGE, Principal, RoomType } from '../../shared';
...
currentAccount: any;
    ...
    loadAll() {
        this.roomTypeService.query({
            ...
            sort: this.sort()}).subscribe(
                (res: HttpResponse<RoomType[]>) => this.onSuccess(res.body, res.headers),
    ...
    transition() {
        this.router.navigate(['/room-type'], {queryParams:
            {
                page: this.page,
                size: this.itemsPerPage,
    ...
    trackId(index: number, item: RoomType) {
        return item.id;
    }
